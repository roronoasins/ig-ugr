...
const QMetaObject _window::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata__window.data,
      qt_meta_data__window,  qt_static_metacall, nullptr, nullptr}
};
...
void *_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__window.stringdata0))
        return static_cast<void*>(const_cast< _window*>(this));
