...
void _hand::draw_illumination_flat_shading()
{
    glMatrixMode(GL_MODELVIEW);
    glPushMatrix();
    Palm.draw_illumination_flat_shading();
    glPopMatrix();

    glPushMatrix();
    glTranslatef(-Palm.getWidth()/2,Palm.getHeight()/2,Palm.getWidth()/2);
    glRotatef(-angle_fingers, 1,0,1);
    F1.draw_illumination_flat_shading();
    glPopMatrix();
    ...
    glRotatef(90,0,1,0);
    glRotatef(-angle_fingers, 1,0,1);
    F2.draw_illumination_flat_shading();
    glPopMatrix();
    ...
    glRotatef(-90,0,1,0);
    glRotatef(-angle_fingers,1,0,1);
    F3.draw_illumination_flat_shading();
    glPopMatrix();

    glPushMatrix();
    glTranslatef(Palm.getWidth()/2,Palm.getHeight()/2,-Palm.getWidth()/2);
    glRotatef(angle_fingers, 1,0,1);
    F4.draw_illumination_flat_shading();
    glPopMatrix();
}
